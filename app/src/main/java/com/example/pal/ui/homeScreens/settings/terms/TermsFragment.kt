...
class TermsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val termsItems: List<TermsItem> = listOf(
            TermsItem(getString(R.string.Terms_and_Conditions),getString(R.string.Terms_last_updated) +
                    "\n\n" +
                    getString(R.string.Read_Terms_Carfully_warning)),
            TermsItem(getString(R.string.Definitions), getString(R.string.For_the_purposes_of_these_Terms_and_Conditions) +
            ...
            TermsItem(getString(R.string.Acknowledgment), getString(R.string.Terms_Acknowledgment_Phrase_one_outOf_Five)+
                    "\n\n"+
            ...
            TermsItem(getString(R.string.Links_to_Other_Websites), getString(R.string.Terms_LinksToOtherWebsites_Phrase_one_outOf_Three)+
                    "\n\n"+
            ...
            TermsItem(getString(R.string.Termination), getString(R.string.Terms_Termination_Phrase_one_outOf_Two)+
                    "\n\n"+
                    getString(R.string.Terms_Termination_Phrase_two_outOf_Two)),
            TermsItem(getString(R.string.Limitation_of_Liability), getString(R.string.Terms_LimitationOfLiability_Phrase_one_outOf_Three)+
                    "\n\n"+
            ...
            TermsItem("\"" +
                    ...
                    "\" " +
                    getString(R.string.Disclaimer), getString(R.string.Terms_Disclaimer_phrase_one_OutOf_Four) +
                    "\"" +
                    getString(R.string.AS_IS) +
                    "\" " +
                    getString(R.string.and) +
            ...
            TermsItem(getString(R.string.Governing_Law), getString(R.string.Terms_GoverningLaw_Description)),
            TermsItem(getString(R.string.Disputes_Resolution), getString(R.string.Terms_DisputeResolution)),
            TermsItem(getString(R.string.For_European_Union_Users), getString(R.string.Terms_For_European_Union_Users)),
            TermsItem(getString(R.string.United_States_Legal_Compliance), getString(R.string.Terms_United_States_Legal_Compliance_one_OutOf_Three) +
                    "\"" +
            ...
            TermsItem(getString(R.string.Translatiom_Interpretation), getString(R.string.Terms_Translatiom_Interpretation)),
            TermsItem(getString(R.string.Changes_to_These_Terms_and_Conditions), getString(R.string.Terms_Changes_to_These_Terms_and_Conditions_one_OutOf_Two)+
                    "\n\n"+
                    getString(R.string.Terms_Changes_to_These_Terms_and_Conditions_two_OutOf_Two)),
            TermsItem(getString(R.string.Contact_Us), getString(R.string.Terms_Contact_Us_one_OutOf_Two)+
                    "\n\n"+
